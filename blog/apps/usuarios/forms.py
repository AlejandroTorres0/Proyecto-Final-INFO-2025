...
class CambiarContrasenaForm(PasswordChangeForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['old_password'].widget.attrs['placeholder'] = 'Contraseña Anterior'
        self.fields['old_password'].widget.attrs['type'] = 'password'
        self.fields['old_password'].label = ''
        #self.fields['old_password'].help_text = '<span class="form-text text-muted"><small>Obligatorio. 150 caracteres o menos. Solo letras, dígitos y @/./+/-/_</small></span>'

        self.fields['new_password1'].widget.attrs['class'] = 'form-control'
        self.fields['new_password1'].widget.attrs['placeholder'] = 'Contraseña Nueva'
        self.fields['new_password1'].widget.attrs['type'] = 'password'
        self.fields['new_password1'].label = ''
        self.fields['new_password1'].help_text = ''

        self.fields['new_password2'].widget.attrs['class'] = 'form-control'
        self.fields['new_password2'].widget.attrs['placeholder'] = 'Contraseña Nueva'
        self.fields['new_password2'].widget.attrs['type'] = 'password'
        self.fields['new_password2'].label = ''
        self.fields['new_password2'].help_text = '<ul class="form-text text-muted small"><li>Tu contraseña no puede ser demasiado similar a tu otra información personal.</li><li>Tu contraseña debe contener al menos 8 caracteres.</li><li>Tu contraseña no puede ser una contraseña de uso común.</li><li>Tu contraseña no puede ser completamente numérica.</li><li>Introduce la misma contraseña que antes, para verificación.</li></ul>'
